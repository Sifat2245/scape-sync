...
const Hero = () => {
  return (
    <section className="w-full overflow-hidden h-[785px]">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-0 z-10">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-20">
          ...
          <div className="lg:w-1/2 text-center lg:text-left relative">
            <div className="absolute bottom-90 right-80">
              <img src={leafSVG} alt="" />
            </div>
            <div className="relative">
              ...
              <div className="absolute -bottom-1 right-30 -z-10">
                <img src={leaf2SVG} alt="" />
              </div>
            </div>
          ...
          <div className="lg:w-1/2 flex justify-center lg:justify-end relative">
            ...
            <div
              className="w-[1440px] h-[124px] absolute -bottom-24 -left-80"
              style={{
                background:
